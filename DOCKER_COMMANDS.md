...
.\docker-stop.ps1           # Windows PowerShell
...
# Or use scripts
./docker-logs.sh backend    # Linux/macOS
.\docker-logs.ps1 backend   # Windows PowerShell
...
# Or use scripts
./docker-status.sh          # Linux/macOS
.\docker-status.ps1         # Windows PowerShell
