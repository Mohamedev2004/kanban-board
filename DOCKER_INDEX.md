...
│
├── 🐚 docker-start.ps1           ← Démarrer (Windows)
├── 🐚 docker-stop.ps1            ← Arrêter (Windows)
├── 🐚 docker-logs.ps1            ← Logs (Windows)
├── 🐚 docker-status.ps1          ← Status (Windows)
│
├── 🐚 docker-start.sh            ← Démarrer (Linux/Mac)
├── 🐚 docker-stop.sh             ← Arrêter (Linux/Mac)
├── 🐚 docker-logs.sh             ← Logs (Linux/Mac)
├── 🐚 docker-status.sh           ← Status (Linux/Mac)
├── 🐚 docker-setup-wizard.sh     ← Setup automatisé
│
├── client/
