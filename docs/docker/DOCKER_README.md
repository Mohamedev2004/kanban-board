...
### 📁 Scripts de Gestion
**Windows (PowerShell):**
- `scripts/docker-start.ps1` - Démarrer l'application
- `scripts/docker-stop.ps1` - Arrêter l'application
- `scripts/docker-logs.ps1` - Voir les logs
- `scripts/docker-status.ps1` - État des services

**Linux/macOS (Bash):**
- `scripts/docker-start.sh` - Démarrer l'application
- `scripts/docker-stop.sh` - Arrêter l'application
- `scripts/docker-logs.sh` - Voir les logs
- `scripts/docker-status.sh` - État des services
