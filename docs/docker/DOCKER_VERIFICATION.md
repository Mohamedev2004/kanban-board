...
│
├── 🐚 scripts/docker-start.ps1            Script démarrage (Windows)
├── 🐚 scripts/docker-stop.ps1             Script arrêt (Windows)
├── 🐚 scripts/docker-logs.ps1             Script logs (Windows)
├── 🐚 scripts/docker-status.ps1           Script status (Windows)
│
├── 🐚 scripts/docker-start.sh             Script démarrage (Linux/Mac)
├── 🐚 scripts/docker-stop.sh              Script arrêt (Linux/Mac)
├── 🐚 scripts/docker-logs.sh              Script logs (Linux/Mac)
├── 🐚 scripts/docker-status.sh            Script status (Linux/Mac)
└── 🐚 scripts/docker-setup-wizard.sh      Script configuration
```
