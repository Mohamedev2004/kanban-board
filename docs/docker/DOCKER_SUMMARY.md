...
|--------|----------|----------|
| `scripts/docker-start.ps1` | Démarrer l'application | Racine |
| `scripts/docker-stop.ps1` | Arrêter l'application | Racine |
| `scripts/docker-logs.ps1` | Voir les logs | Racine |
| `scripts/docker-status.ps1` | État des services | Racine |

#### Linux/macOS (Bash)
| Script | Fonction | Location |
|--------|----------|----------|
| `scripts/docker-start.sh` | Démarrer l'application | Racine |
| `scripts/docker-stop.sh` | Arrêter l'application | Racine |
| `scripts/docker-logs.sh` | Voir les logs | Racine |
| `scripts/docker-status.sh` | État des services | Racine |

#### Utilitaires
| Fichier | Description | Location |
|---------|-------------|----------|
| `Makefile` | Commandes make pour tous systèmes | Racine |
| `scripts/docker-setup-wizard.sh` | Configuration initiale automatisée | Racine |
...
```bash
# Option 1: Script
./scripts/docker-start.sh  # macOS/Linux
