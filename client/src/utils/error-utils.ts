...
export function getApiMessage(t: Translate, error: ApiError) {
  const codeMap: Record<string, string> = {
    ...
    tasks_list_failed: "tasks.errors.loadFailed",
    task_create_failed: "tasks.errors.createFailed",
    task_update_failed: "tasks.errors.updateFailed",
    task_delete_failed: "tasks.errors.deleteFailed",
    task_not_found: "tasks.errors.invalidTask",
    invalid_task_id: "tasks.errors.invalidTask",
    invalid_task_status: "tasks.errors.invalidStatus",
    task_overdue_locked: "tasks.errors.locked",
